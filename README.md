...
I also made use of an open-source repo of Spotify OAuth2.0 Authorization examples. This was released by developers at Spotify in order to make the Authenication process easier for users of their Web API. This was a template and I was able to change css along with endpoints to get my server running and redirecting as nessecary. This repo is linked below:  
